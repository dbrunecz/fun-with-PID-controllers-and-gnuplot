...
set ylabel "Velocity, m/s" tc rgb "#f0f0f0"
...
plot \
DATFILE u 1:2 w lines ls 1, \
DATFILE u 1:3 w lines ls 2, \
DATFILE u 1:4 w lines ls 3, \
DATFILE u 1:5 w lines ls 4, \
DATFILE u 1:6 w lines ls 5
